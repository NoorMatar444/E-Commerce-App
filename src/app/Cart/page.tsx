  ...
  return (
    <>
      {products.length > 0 ? (<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <h1 className="text-center font-bold my-8">Total Prices :{total}</h1>
      ...
      {products.length > 0 ? <div className="clear&checkOut flex justify-around my-8">
        <Link href={`/CheckOut/${cartId}`}>
          <Button className=" bg-green-600 hover:bg-green-700 text-white">Checkout</Button>
        </Link>
        <div className=""><Button onClick={() => clear()} className="bg-red-600">Clear my cart</Button></div>
      </div> :""}
